...
export default function NewStudentPage() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-[#f7f2e8] px-4 py-6 pb-40 sm:px-5">
      <div className="mx-auto grid w-full max-w-5xl gap-6">
        ...
        <form
          onSubmit={save}
          className="grid w-full min-w-0 max-w-full gap-6 overflow-hidden rounded-[30px] bg-white p-4 shadow-sm ring-1 ring-black/10 sm:p-5"
        >
              ...
              <div className="w-full min-w-0 max-w-full overflow-hidden">
                <label className={labelClass}>
                  <span className="inline-flex min-w-0 items-center gap-2">
                    ...
                    <span className="min-w-0 truncate">Dátum skúšok</span>
                  </span>
                </label>
                <input
